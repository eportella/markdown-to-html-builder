...
public class CiteABuildTest
{
    ...
    [InlineData(@"<p>[^2]: Meu segundo contato.", @"<p><br/><cite id=""cite-2""><a href=""#cited-2"">(2)</a>. Meu segundo contato.</cite>")]
    [InlineData(@"</h>[^3]: Meu terceiro contato.", @"</h><br/><cite id=""cite-3""><a href=""#cited-3"">(3)</a>. Meu terceiro contato.</cite>")]
